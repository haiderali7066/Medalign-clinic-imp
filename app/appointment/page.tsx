      ...
      <section className="pt-32 pb-16 px-4 sm:px-6 lg:px-8 bg-muted">
        ...
        >
          ...
          <motion.p variants={itemVariants} className="text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
            Schedule your physiotherapy session with our expert team. Available Monday to Saturday.
          </motion.p>
        </motion.div>
      </section>
        ...
        <div className="max-w-3xl mx-auto">
          {submitted ? (
            ...
            >
              ...
              <h2 className="text-4xl font-bold mb-4 text-primary">Booking Confirmed!</h2>
              <p className="text-lg text-muted-foreground mb-2">Thank you for scheduling your appointment.</p>
            ...
            >
              ...
              {/* Appointment Details */}
              <motion.div variants={itemVariants}>
                <h3 className="text-2xl font-bold mb-6 mt-8">Appointment Details</h3>
              </motion.div>

              <motion.div variants={itemVariants}>
                <label className="block font-semibold mb-2">Service Required *</label>
                <motion.select
                  name="service"
          ...
          {!submitted && (
            ...
            >
              ...
              >
                ...
                <div className="space-y-2 text-muted-foreground text-sm">
                  <p>Phone: +92 (326) 034-1216</p>
                  <p>Email: info@medalign.pk</p>
